 ...
 */
export const feedbackControllerFindAllOptions = (options?: Options<FeedbackControllerFindAllData>) => queryOptions<FeedbackControllerFindAllResponse, AxiosError<DefaultError>, FeedbackControllerFindAllResponse, ReturnType<typeof feedbackControllerFindAllQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
    ...
    queryKey: feedbackControllerFindAllQueryKey(options)
});

export const feedbackControllerFindAllInfiniteQueryKey = (options?: Options<FeedbackControllerFindAllData>): QueryKey<Options<FeedbackControllerFindAllData>> => createQueryKey('feedbackControllerFindAll', options, true);

/**
 * List all feedbacks with user info (Admin only)
 */
export const feedbackControllerFindAllInfiniteOptions = (options?: Options<FeedbackControllerFindAllData>) => infiniteQueryOptions<FeedbackControllerFindAllResponse, AxiosError<DefaultError>, InfiniteData<FeedbackControllerFindAllResponse>, QueryKey<Options<FeedbackControllerFindAllData>>, number | Pick<QueryKey<Options<FeedbackControllerFindAllData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
        const page: Pick<QueryKey<Options<FeedbackControllerFindAllData>>[0], 'body' | 'headers' | 'path' | 'query'> = typeof pageParam === 'object' ? pageParam : {
            query: {
                page: pageParam
            }
        };
    ...
    queryKey: feedbackControllerFindAllInfiniteQueryKey(options)
});

/**
 * Submit feedback (max 5 per minute)
 */
export const feedbackControllerCreateMutation = (options?: Partial<Options<FeedbackControllerCreateData>>): UseMutationOptions<FeedbackControllerCreateResponse, AxiosError<DefaultError>, Options<FeedbackControllerCreateData>> => {
    const mutationOptions: UseMutationOptions<FeedbackControllerCreateResponse, AxiosError<DefaultError>, Options<FeedbackControllerCreateData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await feedbackControllerCreate({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const googleFormControllerAdminTestSubmitMutation = (options?: Partial<Options<GoogleFormControllerAdminTestSubmitData>>): UseMutationOptions<GoogleFormControllerAdminTestSubmitResponse, AxiosError<DefaultError>, Options<GoogleFormControllerAdminTestSubmitData>> => {
...
/**
 * Download corrected data as Excel
 *
 * Downloads flagged submissions with AI-suggested corrections as an Excel file. Requires credits (configurable by admin). Only available for completed AI verifications.
 */
export const verificationControllerDownloadCorrectionsMutation = (options?: Partial<Options<VerificationControllerDownloadCorrectionsData>>): UseMutationOptions<unknown, AxiosError<DefaultError>, Options<VerificationControllerDownloadCorrectionsData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<DefaultError>, Options<VerificationControllerDownloadCorrectionsData>> = {
        mutationFn: async (fnOptions) => {
            const { data } = await verificationControllerDownloadCorrections({
                ...options,
                ...fnOptions,
                throwOnError: true
            });
 ...
 */
export const packageControllerFindAllActiveOptions = (options?: Options<PackageControllerFindAllActiveData>) => queryOptions<PackageControllerFindAllActiveResponse, AxiosError<DefaultError>, PackageControllerFindAllActiveResponse, ReturnType<typeof packageControllerFindAllActiveQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const packageControllerCreateMutation = (options?: Partial<Options<PackageControllerCreateData>>): UseMutationOptions<PackageControllerCreateResponse, AxiosError<DefaultError>, Options<PackageControllerCreateData>> => {
    const mutationOptions: UseMutationOptions<PackageControllerCreateResponse, AxiosError<DefaultError>, Options<PackageControllerCreateData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const packageControllerFindAllOptions = (options?: Options<PackageControllerFindAllData>) => queryOptions<PackageControllerFindAllResponse, AxiosError<DefaultError>, PackageControllerFindAllResponse, ReturnType<typeof packageControllerFindAllQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const packageControllerGetMyPackagesOptions = (options?: Options<PackageControllerGetMyPackagesData>) => queryOptions<PackageControllerGetMyPackagesResponse, AxiosError<DefaultError>, PackageControllerGetMyPackagesResponse, ReturnType<typeof packageControllerGetMyPackagesQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const packageControllerGetActivePackageOptions = (options?: Options<PackageControllerGetActivePackageData>) => queryOptions<PackageControllerGetActivePackageResponse, AxiosError<DefaultError>, PackageControllerGetActivePackageResponse, ReturnType<typeof packageControllerGetActivePackageQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const packageControllerPurchaseMutation = (options?: Partial<Options<PackageControllerPurchaseData>>): UseMutationOptions<PackageControllerPurchaseResponse, AxiosError<DefaultError>, Options<PackageControllerPurchaseData>> => {
    const mutationOptions: UseMutationOptions<PackageControllerPurchaseResponse, AxiosError<DefaultError>, Options<PackageControllerPurchaseData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const packageControllerRemoveMutation = (options?: Partial<Options<PackageControllerRemoveData>>): UseMutationOptions<PackageControllerRemoveResponse, AxiosError<DefaultError>, Options<PackageControllerRemoveData>> => {
    const mutationOptions: UseMutationOptions<PackageControllerRemoveResponse, AxiosError<DefaultError>, Options<PackageControllerRemoveData>> = {
        mutationFn: async (fnOptions) => {
 ...
 */
export const packageControllerFindOneOptions = (options: Options<PackageControllerFindOneData>) => queryOptions<PackageControllerFindOneResponse, AxiosError<DefaultError>, PackageControllerFindOneResponse, ReturnType<typeof packageControllerFindOneQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
 ...
 */
export const packageControllerUpdateMutation = (options?: Partial<Options<PackageControllerUpdateData>>): UseMutationOptions<PackageControllerUpdateResponse, AxiosError<DefaultError>, Options<PackageControllerUpdateData>> => {
    const mutationOptions: UseMutationOptions<PackageControllerUpdateResponse, AxiosError<DefaultError>, Options<PackageControllerUpdateData>> = {
        mutationFn: async (fnOptions) => {
